...
def parse_args():
    ...
    tf.app.flags.DEFINE_integer("train_batch", 10, "No of batches used in training. Set -1 to train on all.")
    tf.app.flags.DEFINE_integer("val_batch", 10, "No of batches used in validaton. Set -1 to validate on all.")
    ...
    tf.app.flags.DEFINE_integer("cluster_mode", 1, "whether the training is on gpu cluster")
