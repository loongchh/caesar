...
class CoattentionBiLSTMWothoutSummaryModel():
    ...
    def coattention_encode(self, preprocessing, debug=False):
        ...
        assert_shape(C_d, "C_d", [None, FLAGS.max_document_size, 4 * FLAGS.state_size])

        # Fusion of temporal information to the coattention context
        with tf.variable_scope("COATTENTION"):
            coatt = tf.concat(2, [D, C_d])
            assert_shape(coatt, "coatt", [None, FLAGS.max_document_size, 6 * FLAGS.state_size])
